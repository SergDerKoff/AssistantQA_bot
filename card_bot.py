...
bot = TeleBot(token='5649218435:AAF5M_UfqBPj9TpL7rrL7jtStwUk60SDRH8', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я умею генерировать номер тестовой банковской карты\nНа кнопке ниже тебе доступны Visa, Maestro, Mastercard и JCB:', # текст сообщения
